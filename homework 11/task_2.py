...
message = 'Сообщение самому себе'
person_name = 'Кутуков Улица'
...
try:
    ...
    sleep(1)
    find_person = browser.find_element(By.CSS_SELECTOR, ".msg-addressee-item [title='Кутуков Улица']")
    find_person.click()
    sleep(1)
